...
public class DateUtil extends org.apache.commons.lang3.time.DateUtils {
	...
	public static final String yyyyMMddHHmmss3 = "yyMMddHHmmss";
	...
	public static String getTomorrowDate() {
		...
		d.applyPattern("yyyy-MM-dd");
		Date nowdate = new Date();
		nowdate = DateUtil.addMinute(1440);
		String str_date = d.format(nowdate);
		return str_date;
	}
	...
	public static String strToFormat(String strDate,String sformat) {
		if (strDate == null) {
			return null;
		}
		Date dtime=new Date(strDate);
		SimpleDateFormat formatter = new SimpleDateFormat(sformat);
	...
	public static Date getNextMonth(Date date) {
		Calendar clar = Calendar.getInstance();
		clar.setTime(date);
		clar.add(Calendar.MONTH,1);
		clar.getActualMinimum(Calendar.DATE);
		return clar.getTime();
	}
